            ...
            <div class="row">
                ...
                <div class="col text-end">
                    <button type="button" onclick="copyLink()" class="btn btn-warning">
                        ...
                        Copy Link</button>
                    <a href="{{route('presence-detail.exportPdf', $presence->id)}}" target="blank" class="btn btn-danger">
...
@push('js')
    <script>
        function copyLink() {
            ...
            navigator.clipboard.writeText("{{route('absen.index',$presence->slug)}}").then(() => {
