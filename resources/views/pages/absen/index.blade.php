                        ...
                        <form id="form-absen" action="{{route ('absen.save', $presence->id)}}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <button type="button" id="clear" class="btn btn-sm btn-secondary">
                                    <svg xmlns="https://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash-fill" viewBox="0 0 16 16">
...
<script>
    $(function(){
        ...
        //set signature textarea
        let signaturePad = new SignaturePad(document.getElementById('signature-pad'), {
            backgroundColor: 'rgb(255, 255, 255, 0)',
            penColor: 'rgb(0, 0, 0)',
        });
        $('canvas').on('mouseup.touch', function() {
